...
public class LoginPage {
    ...
    //Hard Assert:    	
	//If an assertion fails, test execution stops immediately at that line. Remaining code in that test will not run.    
...
//	so I get a full defect report in one run.    
    //Soft Assert:
    //Even if an assertion fails, test execution continues. At the end, you call softAssert.assertAll() to report all failures together.
